package com.hinacle.classscheduleview.listener;
...
public class OnSlideBuildAdapter implements ISchedule.OnSlideBuildListener {
    ...
    public OnSlideBuildAdapter hideNumberTextView(){
        showNumberTextView = false;
        return this;
    }

    public OnSlideBuildAdapter showNumberTextView(){
        showNumberTextView = true;
        return this;
    }
    @Override
    public View getView(int pos, LayoutInflater inflater, int itemHeight, int marTop) {
        ...
        numberTextView.setVisibility(showNumberTextView? View.VISIBLE:View.GONE);
