package com.hinacle.classscheduleview.operater;
...
import com.hinacle.classscheduleview.R;
import com.hinacle.classscheduleview.TimetableView;
import com.hinacle.classscheduleview.listener.ISchedule;
import com.hinacle.classscheduleview.model.Schedule;
import com.hinacle.classscheduleview.model.ScheduleConfig;
import com.hinacle.classscheduleview.model.ScheduleSupport;
import com.hinacle.classscheduleview.utils.ColorUtils;
...
public class SimpleOperater extends AbsOperater{
    ...
    protected void initPanel() {
        for (int i = 0; i < panels.length; i++) {
             ...
             * 点击空白格子时才会触发这个事件
             */
            panels[i].setOnTouchListener((arg0, arg1) -> {
